...
{
    public TransitSignalPriorityRequestKind m_RequestKind;
    public TransitSignalPriorityApproachLaneRole m_ApproachLaneRole;
    ...
    public TransitSignalPriorityTrackProbeResult m_TrackSignaledLaneProbe;
    public TransitSignalPriorityTrackProbeResult m_TrackApproachLaneProbe;
    public TransitSignalPriorityTrackProbeResult m_TrackUpstreamLaneProbe;
    public float m_TrackSignaledLaneCurvePosition;
    public float m_TrackApproachLaneCurvePosition;
    public float m_TrackUpstreamLaneCurvePosition;
