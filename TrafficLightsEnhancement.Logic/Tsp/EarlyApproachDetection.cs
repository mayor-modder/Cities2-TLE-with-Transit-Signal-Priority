...
public readonly struct TransitApproachScanState
{
    public TransitApproachScanState(TspRequest? earlyRequest, TspRequest? petitionerRequest)
    {
        EarlyRequest = earlyRequest;
        PetitionerRequest = petitionerRequest;
    }

    public TspRequest? EarlyRequest { get; }
    public TspRequest? PetitionerRequest { get; }
}
...
public static class EarlyApproachDetection
{
        ...
        TspRequest? petitionerRequest)
    {
        return new TransitApproachScanState(
            state.EarlyRequest ?? earlyRequest,
            state.PetitionerRequest ?? petitionerRequest);
    }
